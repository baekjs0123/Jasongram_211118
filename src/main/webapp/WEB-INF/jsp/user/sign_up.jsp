		...
		<div class="sign-up-box">
			<div class="pl-3 pt-3">
				...
				<div class="d-flex">
					...
					<button type="button" id="checkDuplicateBtn"
						class="btn btn-info ml-3">중복확인</button>
				</div>
			...
			<div class="pl-3 pt-3">
				<span>password</span> <input type="password" id="password"
					name="password" class="form-control col-9">
			</div>
			<div class="pl-3 pt-3">
				<span>confirm password</span> <input type="password"
					id="confirmPassword" class="form-control col-9">
			</div>
			<div class="pl-3 pt-3">
				<span>이름</span> <input type="text" id="name" name="name"
					class="form-control col-9" placeholder="이름을 입력해주세요.">
			</div>
			<div class="pl-3 pt-3">
